...
public class ListProductAdapter extends XRecyclerView.Adapter {
    private Context context;
    private List<ListProductBean.DataBean> data;
    ...
    public ListProductAdapter(Context context, List<ListProductBean.DataBean> data) {
    ...
    public interface OnItemClickListener {
        void onItemClick(int position, ListProductBean.DataBean dataBean);
    }
}
